...
fn main() {
    let mesh = Mesh {
        ...
        edges: vec![
            Edge{vertices: [0, 1], normals: [1, 1]},
            Edge{vertices: [0, 2], normals: [2, 2]},
            Edge{vertices: [0, 3], normals: [3, 3]},
            Edge{vertices: [1, 2], normals: [0, 0]},
            Edge{vertices: [2, 3], normals: [0, 0]},
            Edge{vertices: [3, 1], normals: [0, 0]},
        ],
