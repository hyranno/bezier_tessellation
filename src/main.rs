...
fn main() {
    ...
    let mesh = if args.len() <= 1 {
        sample_data::dome::create()
    } else {
        match args[1].as_str() {
            "dome" => sample_data::dome::create(),
            "pyramid" => sample_data::pyramid::create(),
            "cylinder" => sample_data::cylinder::create(),
            "cone" => sample_data::cone::create(),
            _ => sample_data::dome::create(),
        }
    };
